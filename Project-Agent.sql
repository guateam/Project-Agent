...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '收藏：用户-答案映射' ROW_FORMAT = Compact;
...
CREATE TABLE `demands`  (
  ...
  `userID` int(10) NOT NULL,
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `allowedUserGroup` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户-话题 关注关系映射表' ROW_FORMAT = Compact;
...
CREATE TABLE `groups`  (
  ...
  `userID` int(10) NOT NULL,
  `head_portrait` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `state` int(2) NOT NULL DEFAULT 0,
...
CREATE TABLE `pay_log`  (
  ...
  `receive` int(255) NULL DEFAULT NULL COMMENT '钱的接收ID ,问题ID或专家ID或告示板需求ID',
  `amount` int(255) NULL DEFAULT NULL COMMENT '金额数量',
  `type` int(255) NULL DEFAULT NULL COMMENT '交易形式  1-付费问答  2-专家咨询  3-告示板需求',
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '问题评论' ROW_FORMAT = Compact;
...
CREATE TABLE `questions`  (
  ...
  `allowed_user` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `search_word`  (
  `content` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '搜索的内容',
